...
致关注本项目的用户：很抱歉，由于存储此项目的硬盘是国内某品牌（铭瑄，和台电一样属于商科集团）的黑片固态，掉盘后数据全部丢失（PC3000无解），再加上我~~比较偷懒~~，没能实时将对Chromium的patch备份到GitHub和GitLab上（大概也有几十个commit了，为了HEVC和其他功能做了许多研究，毕竟网上的解决方案并不适用于现在的最新内核版本，可惜这些commit找不回来了），因此此项目可能之后都将会搁置 ----2021年9月留

### 迪莫乐浏览器是基于Chromium 93.0.4577.27等内核的浏览器，完美兼容大多数网页，支持云同步，是聚集众多功能、致力于缩减chromium体积的电脑版浏览器
